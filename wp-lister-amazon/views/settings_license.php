...
<!-- 							<p class="desc" style="display: block; font-style: normal">
 ...
 -->
					...
					<p style="margin-top: 0; float: left;">
	                    <a href="<?php echo $wpl_form_action ?>&action=wpla_force_update_check&_wpnonce=<?php echo wp_create_nonce( 'wpla_force_update_check' ); ?>" class="button"><?php echo __('Force update check','wpla'); ?></a>
    	                &nbsp; Last check: <?php echo $wpl_last_update ?>
					</p>

					<?php if ( $wpl_text_license_email ) : ?>
	        		<p style="margin-top: 0; float: right;">
	                    <a href="<?php echo $wpl_form_action ?>&action=wpla_check_license_status&_wpnonce=<?php echo wp_create_nonce( 'wpla_check_license_status '); ?>" class="button"><?php echo __('Check license activation','wpla'); ?></a>
						<!-- &nbsp; -->
