        ...
        public function panel_field_content ( $field ) {
            ...
            switch ( $field[ 'type' ] ) {
                ...
                case 'datepicker':
                    ...
                    $echo = "<input type='text' id='{$id}_date' name='{$name}[date]' value='{$value['date']}' class='medium-text code panel-datepicker' colorpicker='" . __ ( 'Select a date', 'yith-woocommerce-zoom-magnifier' ) . "' /> - ";
                    $echo .= "<input type='text' id='{$id}_hh' name='{$name}[hh]' value='{$value['hh']}' class='small-text code' colorpicker='" . __ ( 'Hours', 'yith-woocommerce-zoom-magnifier' ) . "' /> : ";
                    $echo .= "<input type='text' id='{$id}_mm' name='{$name}[mm]' value='{$value['mm']}' class='small-text code' colorpicker='" . __ ( 'Minutes', 'yith-woocommerce-zoom-magnifier' ) . "' /> : ";
                    $echo .= "<input type='text' id='{$id}_ss' name='{$name}[ss]' value='{$value['ss']}' class='small-text code' colorpicker='" . __ ( 'Minutes', 'yith-woocommerce-zoom-magnifier' ) . "' />";
                    if ( isset( $field[ 'description' ] ) && $field[ 'description' ] != '' ) {
                        $echo .= "<p class='description'>{$field['description']}</p>";
                    }
                    break;
                ...
                case 'upload':
                    ...
                    $echo .= "  <input type='text' id='{$id}' name='{$name}' value='{$value}' class='regular-text code' /> <input type='button' name='' id='{$id}_button' class='button' value='" . __ ( 'Upload', 'yith-woocommerce-zoom-magnifier' ) . "'>";
                    $echo .= '</div>';
                    if ( isset( $field[ 'description' ] ) && $field[ 'description' ] != '' ) {
                        $echo .= "<p class='description'>{$field['description']}</p>";
                    }
                    ...
                    <div class="typography_container typography">
                        <div class="option">
                            ...
                            <div class="select-wrapper font-unit">
                                <select class="typography_unit" name="<?php echo $name ?>[unit]"
                                        id="<?php echo $id ?>-unit">
                                    <option
                                        value="px" <?php selected ( $value[ 'unit' ], 'px' ) ?>><?php _e ( 'px', 'yith-woocommerce-zoom-magnifier' ) ?></option>
                                    <option
                                        value="em" <?php selected ( $value[ 'unit' ], 'em' ) ?>><?php _e ( 'em', 'yith-woocommerce-zoom-magnifier' ) ?></option>
                                    <option
                                        value="pt" <?php selected ( $value[ 'unit' ], 'pt' ) ?>><?php _e ( 'pt', 'yith-woocommerce-zoom-magnifier' ) ?></option>
                                    <option
                                        value="rem" <?php selected ( $value[ 'unit' ], 'rem' ) ?>><?php _e ( 'rem', 'yith-woocommerce-zoom-magnifier' ) ?></option>
                                </select>
                            </div>
                            ...
                            <div class="select-wrapper font-family">
                                <select class="typography_family" name="<?php echo $name ?>[family]"
                                    ...
                                    <?php else: ?>
                                        <option
                                            value=""><?php _e ( 'Select a font family', 'yith-woocommerce-zoom-magnifier' ) ?></option>
                                    <?php endif ?>
                                </select>
                            </div>
                            ...
                            <div class="select-wrapper font-style">
                                <select class="typography_style" name="<?php echo $name ?>[style]"
                                    ...
                                    <option
                                        value="regular" <?php selected ( $value[ 'style' ], 'regular' ) ?>><?php _e ( 'Regular', 'yith-woocommerce-zoom-magnifier' ) ?></option>
                                    <option
                                        value="bold" <?php selected ( $value[ 'style' ], 'bold' ) ?>><?php _e ( 'Bold', 'yith-woocommerce-zoom-magnifier' ) ?></option>
                                    <option
                                        value="extra-bold" <?php selected ( $value[ 'style' ], 'extra-bold' ) ?>><?php _e ( 'Extra bold', 'yith-woocommerce-zoom-magnifier' ) ?></option>
                                    <option
                                        value="italic" <?php selected ( $value[ 'style' ], 'italic' ) ?>><?php _e ( 'Italic', 'yith-woocommerce-zoom-magnifier' ) ?></option>
                                    <option
                                        value="bold-italic" <?php selected ( $value[ 'style' ], 'bold-italic' ) ?>><?php _e ( 'Italic bold', 'yith-woocommerce-zoom-magnifier' ) ?></option>
                                </select>
                            </div>
                        ...
                        <div class="font-preview">
                            ...
                            <div class="refresh_container">
                                <button
                                    class="refresh"><?php _e ( 'Click to preview', 'yith-woocommerce-zoom-magnifier' ) ?></button>
                            </div>
                        </div>
                    </div>
                    <?php
