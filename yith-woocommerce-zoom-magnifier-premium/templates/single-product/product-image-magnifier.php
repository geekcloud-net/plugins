...
<div class="images<?php if ( $is_IE ): ?> ie<?php endif ?>">
    ...
    if ( has_post_thumbnail () ) {
        ...
        echo apply_filters ( 'woocommerce_single_product_image_html', sprintf ( '<div class="woocommerce-product-gallery__image"><a href="%s" itemprop="image" class="yith_magnifier_zoom woocommerce-main-image" title="%s">%s</a></div>', $magnifier_url, $image_title, $image ), $post->ID );
