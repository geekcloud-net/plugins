...
?>
<div class="thrv_ult_widget thrv_wrapper tve_no_drag tve_no_icons tve_element_hover tve_set_10 tve_teal" style="background-image: url('<?php echo TVE_Ult_Const::plugin_url("tcb-bridge/editor-templates/css/images/64_set_bg.png") ?>');background-repeat: no-repeat; background-position: left top;">
