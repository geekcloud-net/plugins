...
?>
<div class="thrv_ult_widget thrv_wrapper tve_no_drag tve_no_icons tve_element_hover tve_set_14 tve_teal" style="background-image: url('<?php echo TVE_Ult_Const::plugin_url("tcb-bridge/editor-templates/css/images/set_68_bg_large.jpg") ?>'); background-size:cover; background-position: center bottom;">
