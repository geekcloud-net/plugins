...
?>
<div class="thrv_ult_widget thrv_wrapper tve_no_drag tve_no_icons tve_element_hover tve_set_06 tve_red" style="background-image: url('<?php echo TVE_Ult_Const::plugin_url("tcb-bridge/editor-templates/css/images/tvu_set_06_widget_bg.png") ?>'); background-size:cover; background-position: center bottom;">
