...
?>
<div class="thrv_ult_bar tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tvu_set_14 tve_teal" style="background-image: url('<?php echo TVE_Ult_Const::plugin_url('tcb-bridge/editor-templates/css/images/set_68_bg.png') ?>');background-position: left top;background-repeat: no-repeat;">
