...
?>
<div class="thrv_ult_bar tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tvu_set_01 tve_white" style="background-image: url('<?php echo TVE_Ult_Const::plugin_url("tcb-bridge/editor-templates/css/images/tvu_set1_bg.jpg") ?>'); background-size:cover; background-position: center center;">
