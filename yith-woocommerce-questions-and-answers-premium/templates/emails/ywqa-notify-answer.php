...
<?php do_action( 'woocommerce_email_header', $email_heading, $email ); ?>
	...
	<div class="ywqa-header">
		...
		<div class="ywqa-description">
			<?php _e( "There is a new answer for the question: ", 'yith-woocommerce-questions-and-answers' ); ?>
	...
	<div class="ywqa-content">
		<div class="ywqa-content-intro"><?php _e( "The answer", 'yith-woocommerce-questions-and-answers' ); ?></div>
	...
	<div class="ywqa-bottom">
		<a class="ywqa-view-product" href="<?php echo get_permalink( $answer->product_id ); ?>">
			<?php _e( 'View product', 'yith-woocommerce-questions-and-answers' ); ?></a>
	</div>
