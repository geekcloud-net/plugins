...
if ( ! class_exists( "YWQA_Email_Ask_Customers_Answer" ) ) {
	...
	class YWQA_Email_Ask_Customers_Answer extends WC_Email {
		...
		public function __construct() {
			...
			$this->title = __( "YITH Q&A - ask answer to customers", 'yith-woocommerce-questions-and-answers' );

			// this is the description in WooCommerce email settings
			$this->description = __( 'When a new question is submitted for a product, ask a feedback to the customers that purchased the same product', 'yith-woocommerce-questions-and-answers' );

			// these are the default heading and subject lines that can be overridden using the settings
			$this->heading = __( 'Give your feedback', 'yith-woocommerce-questions-and-answers' );

			$this->subject = __( '[{site_title}] A user need your feedback for [{product_title}]', 'yith-woocommerce-questions-and-answers' );
