...
if ( ! class_exists( "YWQA_Email_Notify_Answer" ) ) {
	...
	class YWQA_Email_Notify_Answer extends WC_Email {
		...
		public function __construct() {
			...
			$this->title = __( "YITH Q&A - New answer notification", 'yith-woocommerce-questions-and-answers' );

			// this is the description in WooCommerce email settings
			$this->description = __( 'When an answer is submitted, sent a notification to the user who submitted the question', 'yith-woocommerce-questions-and-answers' );

			// these are the default heading and subject lines that can be overridden using the settings
			$this->heading = __( 'You have a new answer for [{product_title}]', 'yith-woocommerce-questions-and-answers' );
			$this->subject = __( '[{site_title}] You have a new answer for [{product_title}]', 'yith-woocommerce-questions-and-answers' );
		...
		public function trigger( $args ) {
			...
			$product_title = wc_get_product( $answer->product_id )->get_title();
