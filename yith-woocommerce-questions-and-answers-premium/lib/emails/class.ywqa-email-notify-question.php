...
if ( ! class_exists( "YWQA_Email_Notify_Question" ) ) {
	...
	class YWQA_Email_Notify_Question extends WC_Email {
		...
		public function __construct() {
			...
			$this->title = __( "YITH Q&A - New question notification", 'yith-woocommerce-questions-and-answers' );

			// this is the description in WooCommerce email settings
			$this->description = __( 'New question emails are sent to chosen recipient(s) when a new question is submitted for some product.', 'yith-woocommerce-questions-and-answers' );

			// these are the default heading and subject lines that can be overridden using the settings
			$this->heading = __( 'You have a new question for [{product_title}]', 'yith-woocommerce-questions-and-answers' );
			$this->subject = __( '[{site_title}] You have a new question for [{product_title}]', 'yith-woocommerce-questions-and-answers' );
		...
		public function trigger( $args ) {
			...
			$product_title = wc_get_product( $question->product_id )->get_title();
