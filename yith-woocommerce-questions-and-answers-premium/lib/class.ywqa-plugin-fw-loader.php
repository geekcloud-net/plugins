...
if ( ! class_exists( 'YWQA_Plugin_FW_Loader' ) ) {
	...
	class YWQA_Plugin_FW_Loader {
		...
		public function register_panel() {
			...
			$admin_tabs['advanced'] = __( 'Advanced', 'yith-woocommerce-questions-and-answers' );
		...
		public function register_pointer() {
			...
			$args[] = array(
				...
				'content'    => sprintf( '<h3> %s </h3> <p> %s </p>',
					...
					__( 'In YIT Plugins tab you can find YITH WooCommerce Questions and Answers options.<br> From this menu you can access all settings of YITH plugins activated.', 'yith-woocommerce-questions-and-answers' ) . '<br>' . $premium_message
				),
