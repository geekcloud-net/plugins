...
if ( ! class_exists( 'YITH_WCMC_Widget' ) ) {
	...
	class YITH_WCMC_Widget extends WP_Widget {
		...
		public function form( $instance ) {
			?>
			<p>
				<?php echo sprintf( __( 'You can customize options for <b>Mailchimp Subscription Form</b> widget from YITH WooCommerce Mailchimp <a href="%s">admin page</a>', 'yith-woocommerce-mailchimp' ), esc_url( add_query_arg( array( 'page' => 'yith_wcmc_panel', 'tab' => 'widget' ), admin_url( 'admin.php' ) ) ) )?>
			</p>
			<?php
		}
