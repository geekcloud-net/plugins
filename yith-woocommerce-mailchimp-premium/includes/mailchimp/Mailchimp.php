...
class Mailchimp {
    ...
    public function call($url, $params) {
	    ...
	    // SSL Options
	    if (isset( $this->ssl_verifypeer )) curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, $this->ssl_verifypeer);
	    if (isset( $this->ssl_verifyhost )) curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, $this->ssl_verifyhost);
	    if (isset( $this->ssl_cainfo )) curl_setopt($ch, CURLOPT_CAINFO, $this->ssl_cainfo);
