...
<p><?php _e( "Hi, a note has just been added to your order:", 'woocommerce' ); ?></p>
...
<table id="yith-wcet-order-items-table" cellspacing="0" cellpadding="6" style="width: 100%;">
	...
	<tbody>
		<?php echo $order->email_order_items_table( $order->is_download_permitted(), true, false, $show_thumbs ); ?>
	</tbody>
