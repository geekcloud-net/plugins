...
$price_title_bg_color     = ( isset( $meta[ 'price_title_bg_color' ] ) ) ? $meta[ 'price_title_bg_color' ] : '#444444';
...
// --------- Header Padding -----------
$header_padding_default = array( 25, 25, 25, 25 );
...
?>
    ...
    .yith-wcet-order-items-table-element td{
    ...
    .yith-wcet-order-items-table-el-quantity-last,
    .yith-wcet-order-items-table-el-quantity-not-last,
    .yith-wcet-order-items-table-el-price-last,
    .yith-wcet-order-items-table-el-price-not-last {
    ...
    #yith-wcet-total-price, #yith-wcet-total-title{
    border-top:<?php echo esc_attr( $table_border_width ); ?> solid <?php echo esc_attr( $table_border_color ); ?>;
    border-bottom:<?php echo esc_attr( $table_border_width ); ?> solid <?php echo esc_attr( $table_border_color ); ?>;
    }
