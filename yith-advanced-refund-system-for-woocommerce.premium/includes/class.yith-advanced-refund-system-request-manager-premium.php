	    ...
	    public function create_coupon() {
		    ...
		    try {
			    if ( ! current_user_can( 'publish_shop_coupons' ) ) {
				    throw new Exception( __( 'You do not have permission to create coupons.', 'yith-advanced-refund-system-for-woocommerce' ) );
			    }
			    ...
			    if ( ! $order ) {
				    throw new Exception( __( 'Order does not exist.', 'yith-advanced-refund-system-for-woocommerce' ) );
			    }
			    ...
			    if ( is_wp_error( $id ) ) {
				    throw new Exception( __( 'Error: invalid data when creating coupon.', 'yith-advanced-refund-system-for-woocommerce' ) );
			    }
