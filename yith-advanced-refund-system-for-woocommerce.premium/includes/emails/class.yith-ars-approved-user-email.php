...
if ( ! class_exists( 'YITH_ARS_Approved_User_Email' ) ) {
	...
	class YITH_ARS_Approved_User_Email extends WC_Email {
		...
		public function __construct() {
			...
			$this->title         = _x( 'YITH Advanced Refund System: Approved Refund Request email for user', 'Email descriptive title',
			...
			$this->heading       = __( 'Your refund request has been approved!', 'yith-advanced-refund-system-for-woocommerce' );
			$this->subject       = __( 'Your refund request has been approved!', 'yith-advanced-refund-system-for-woocommerce' );
            $this->email_body    = __( 'Hi {customer_name}! Your refund request {request_number} for order {order_number} has been approved!', 'yith-advanced-refund-system-for-woocommerce' );
		...
		public function trigger( $request_id ) {
            ...
            $this->email_body = $this->get_option( 'email_body', __( 'Hi {customer_name}! Your refund request {request_number} for order {order_number} has been approved!', 'yith-advanced-refund-system-for-woocommerce' ) );
