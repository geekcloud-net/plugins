...
if ( ! class_exists( 'YITH_ARS_Coupon_User_Email' ) ) {
    ...
    class YITH_ARS_Coupon_User_Email extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->title = _x( 'YITH Advanced Refund System: email for users for coupon offer', 'Email descriptive title',
                'yith-advanced-refund-system-for-woocommerce' );
            $this->description = __( 'The user will receive an email when a coupon is offered in place of a refund.',
                'yith-advanced-refund-system-for-woocommerce' );

	        $this->subject = $this->get_option( 'subject', __( "You've received a Coupon Code", 'yith-advanced-refund-system-for-woocommerce' ) );
	        $this->heading = $this->get_option( 'heading', __( "You've received a Coupon Code", 'yith-advanced-refund-system-for-woocommerce' ) );
	        $this->email_body = $this->get_option( 'email_body', __( "Hi {customer_name}. You've received a Coupon Code for your order
