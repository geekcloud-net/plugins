    ...
    class YITH_Advanced_Refund_System_Frontend_Premium extends YITH_Advanced_Refund_System_Frontend {
        ...
        public function refund_single_product_button( $item_id, $item, $order ) {
	        ...
	        if ( $this->product_can_show_refundable_button( $order, $product_id ) ) {
		        ...
		        if ( $max_quantity ) {
                    ...
                    <div>
                        <a class="button ywcars_button_refund" data-rel="prettyPhoto"
                           href="<?php echo $link; ?>"><?php _e( 'Refund', 'yith-advanced-refund-system-for-woocommerce' ); ?></a>
                    </div>
			        <?php
		        } else {
			        ?>
                    <div>
                        <button disabled title="<?php _e( 'No further refunds can be granted on this item', 'yith-advanced-refund-system-for-woocommerce' ); ?>"
                           class="button ywcars_button_refund" ><?php _e( 'Refund', 'yith-advanced-refund-system-for-woocommerce' ); ?></button>
                    </div>
			        <?php
                }
	        } else {
		        ?>
                <div>
                    <button disabled title="<?php _e( 'No refund shall be granted on this product', 'yith-advanced-refund-system-for-woocommerce' ); ?>"
                       class="button ywcars_button_refund"><?php _e( 'Refund', 'yith-advanced-refund-system-for-woocommerce' ); ?></button>
                </div>
		        <?php
            }
        ...
        public function add_qty_field_to_form( $order, $is_whole_order ) {
            ...
            <div class="ywcars_block">
                <label><?php _e( 'Please, select the amount of items:', 'yith-advanced-refund-system-for-woocommerce' ); ?>
	    ...
	    public function add_attachment_field_to_form( $order, $is_whole_order ) {
            ...
            <div class="ywcars_block">
                <div><label for="ywcars_form_attachment"><?php
					    _e( 'Attach a file (optional)', 'yith-advanced-refund-system-for-woocommerce' );
					    ?></label></div>
