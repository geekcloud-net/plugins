    ...
    class YITH_Advanced_Refund_System_Admin_Premium extends YITH_Advanced_Refund_System_Admin {
        ...
        public function refunds_tab( $product_data_tabs ) {
            $new_tab = array(
                'ywcars_refunds' => array(
                    'label'  => __( 'Refunds', 'yith-advanced-refund-system-for-woocommerce' ),
        ...
        public function refunds_tab_content() {
            ...
            <div class="options_group">
                <fieldset class="form-field _ywpo_price_adjustment_field">
                    <legend><?php
                        _e( 'Set the refundable status', 'yith-advanced-refund-system-for-woocommerce' );
                        ?></legend>
                    <ul class="wc-radios">
                        <li>
                            <label>
                                ...
                                />
                                <span><?php
                                    _e( 'Use the global value', 'yith-advanced-refund-system-for-woocommerce' );
                                    echo ' (';
                                    _e( 'Currently:', 'yith-advanced-refund-system-for-woocommerce' );
	                                echo ' ';
                                    if ( 'yes' == $refundable_global_option ) {
                                        _e( 'Yes', 'yith-advanced-refund-system-for-woocommerce' );
                                    } else {
                                        _e( 'No', 'yith-advanced-refund-system-for-woocommerce' );
                                    }
                                    echo ')';
                                    ?></span>
                            </label>
                        ...
                        <li>
                            <label>
                                ...
                                />
                                <?php echo __( 'Set the product as refundable', 'yith-advanced-refund-system-for-woocommerce' ); ?>
                            </label>
                        </li>
                        <li>
                            <label>
                                ...
                                />
                                <?php echo __( 'Set the product as non-refundable', 'yith-advanced-refund-system-for-woocommerce' ); ?>
                            </label>
                        </li>
                    </ul>
                    <?php echo wc_help_tip( __( 'Choose whether refunds are allowed for this product or not.',
            ...
            ?><div class="options_group">
                <fieldset class="form-field _ywpo_price_adjustment_field">
                    <legend><?php
                        _e( 'Number of days for refund', 'yith-advanced-refund-system-for-woocommerce' );
                        ?></legend>
                    <ul class="wc-radios">
                        <li>
                            <label>
                        ...
                        <li>
                            <label>
                                ...
                                />
                                <?php echo __( 'Set a custom number of days', 'yith-advanced-refund-system-for-woocommerce' ); ?>
                            </label>
                        </li>
                    </ul>
                    <?php echo wc_help_tip( __( 'Enter the maximum time (in days) to allow refunds. Set 0 if refunds for this product are always
                    available',
                        'yith-advanced-refund-system-for-woocommerce' ) ); ?>
                </fieldset><?php
                woocommerce_wp_text_input( array(
                    'id'                => '_ywcars_ndays_refund',
                    'label'             => __( 'Custom number of days', 'yith-advanced-refund-system-for-woocommerce' ),
                    'desc_tip'          => true,
                    'description'       => __( '0 means that refunds for this product are always available',
                        'yith-advanced-refund-system-for-woocommerce' ),
                    'type'              => 'number',
            ...
            ?><div class="options_group">
                <fieldset class="form-field _ywpo_price_adjustment_field">
                    <legend><?php
                        _e( 'Non-refundable message', 'yith-advanced-refund-system-for-woocommerce' );
                        ?></legend>
                    <ul class="wc-radios">
                        <li>
                            <label>
                                ...
                                echo $message_general ?
                                    sprintf( __( 'Current message: \'%s\'', 'yith-advanced-refund-system-for-woocommerce' ), $message_general ) : ''; ?>"><?php
                                    _e( 'Use the global value', 'yith-advanced-refund-system-for-woocommerce' );
                                    ?></span>
                            </label>
                        </li>
                        <li>
                            <label>
                                ...
                                />
                                <?php echo __( 'Use a custom message', 'yith-advanced-refund-system-for-woocommerce' ); ?>
                            </label>
                        </li>
                    </ul>
                    <?php echo wc_help_tip( __( 'Select a message to show on non-refundable products',
                        'yith-advanced-refund-system-for-woocommerce' ) ); ?>
                </fieldset><?php

                woocommerce_wp_text_input( array(
                    'id'                => '_ywcars_message',
                    'label'             => __( 'Custom message', 'yith-advanced-refund-system-for-woocommerce' ),
                    'desc_tip'          => true,
                    'description'       => __( 'Set a custom message that will be shown on the product page.',
                        'yith-advanced-refund-system-for-woocommerce' ),
                    'type'              => 'text'
                ) );
        ...
        public function variations_content( $loop, $variation_data, $variation ) {
            ...
            <div class="ywcars_refunds_product_variations_data">
                <fieldset class="form-row form-row-full">
                    <p><?php _e( 'Set the refundable status', 'yith-advanced-refund-system-for-woocommerce' );
				        echo wc_help_tip( __( 'Choose whether the product allows refunds or not.',
					        'yith-advanced-refund-system-for-woocommerce' ) );
				        ?></p>
                    <p class="form-row form-row-full options">
                        <label>
                            ...
                            />
                            <span><?php
						        _e( 'Global value', 'yith-advanced-refund-system-for-woocommerce' );
						        echo ' (';
						        _e( 'Currently:', 'yith-advanced-refund-system-for-woocommerce' );
						        if ( 'yes' == $refundable_global_option ) {
							        echo ' ' . __( 'Yes', 'yith-advanced-refund-system-for-woocommerce' );
						        } else {
							        echo ' ' . __( 'No', 'yith-advanced-refund-system-for-woocommerce' );
						        }
						        echo ')';
						        ?></span>
                        </label>
                        <label>
                            ...
                            />
					        <?php _e( 'Parent value', 'yith-advanced-refund-system-for-woocommerce' ); ?>
                        </label>
                        <label>
                            <input name="<?php echo esc_attr( '_ywcars_refundable[' . $loop . ']' ); ?>"
                                   value="<?php echo esc_attr( 'yes' ); ?>" type="radio"
						        ...
						        <?php echo checked( $refundable, esc_attr( 'yes' ), false ); ?>
                            />
					        <?php _e( 'Refundable', 'yith-advanced-refund-system-for-woocommerce' ); ?>
                        </label>
                        <label>
                            <input name="<?php echo esc_attr( '_ywcars_refundable[' . $loop . ']' ); ?>"
                                   value="<?php echo esc_attr( 'no' ); ?>" type="radio"
						        ...
						        <?php echo checked( $refundable, esc_attr( 'no' ), false ); ?>
                            />
					        <?php _e( 'Non-refundable', 'yith-advanced-refund-system-for-woocommerce' ); ?>
                        </label>
                    </p>
                </fieldset>
		        <?php
		        ...
		        ?>
                <fieldset class="form-row form-row-full">
                    <p><?php _e( 'Number of days for refund', 'yith-advanced-refund-system-for-woocommerce' );
				        echo wc_help_tip( __( 'Enter the maximum time (in days) to allow refunds. 0 means that refunds for this product are always
				        available',
					        'yith-advanced-refund-system-for-woocommerce' ) );
				        ?></p>
                    <p class="form-row form-row-full options">
                        ...
                        <label>
                            <input name="<?php echo esc_attr( '_ywcars_ndays_refund_type[' . $loop . ']' ); ?>"
						        ...
						        <?php echo checked( $ndays_refund_type, esc_attr( 'custom' ), false ); ?>
                            />
					        <?php echo __( 'Set custom number of days', 'yith-advanced-refund-system-for-woocommerce' ); ?>
                        </label>
                    </p>
	                <?php
                    ...
                    <p class="form-row form-row-first _ywcars_ndays_refund_variation_field" style="display: <?php echo $display_custom_ndays_style; ?>">
                        <label><?php _e( 'Custom number of days', 'yith-advanced-refund-system-for-woocommerce' ); ?> <?php echo wc_help_tip( __( '0 means that refunds for this product are always available', 'yith-advanced-refund-system-for-woocommerce' ) ); ?></label>
		        ...
		        ?>
                <fieldset class="form-row form-row-full">
                    <p><?php _e( 'Non-refundable message', 'yith-advanced-refund-system-for-woocommerce' );
				        echo wc_help_tip( __( 'Select which message to show on non-refundable products',
					        'yith-advanced-refund-system-for-woocommerce' ) );
				        ?></p>
                    <p class="form-row form-row-full options">
                        <label>
                    ...
                    <p class="form-row form-row-first _ywcars_message_variation_field" style="display: <?php echo $display_custom_message_style; ?>">
                        <label><?php _e( 'Custom message', 'yith-advanced-refund-system-for-woocommerce' ); ?> <?php echo wc_help_tip( __( 'Set a custom message that will be shown on the product page.', 'yith-advanced-refund-system-for-woocommerce' ) ); ?></label>
	    ...
	    public function show_go_to_coupon_link( $request ) {
		    if ( 'ywcars-coupon' == $request->status && $request->coupon_id ) {
			    ...
			    ?>
                <div><?php printf( __( 'Go to coupon: %s', 'yith-advanced-refund-system-for-woocommerce' ), $coupon_link ); ?></div>
			    <?php
		    }
	    }
	    ...
	    public function add_offer_coupon_button( $request, $refund_amount ) {
            ...
            <button class="ywcars_request_action_button button button-secondary" id="ywcars_offer_coupon_button">
                <span><?php printf( __( 'Offer a coupon for %s', 'yith-advanced-refund-system-for-woocommerce' ), $refund_amount ); ?></span>
            </button>
            <?php
        }
        ...
        public function add_premium_plugin_options( $settings ) {
            $premium_settings = array(
	            ...
	            'refunds_title' => array(
		            'title' => __( 'Refunds', 'yith-advanced-refund-system-for-woocommerce' ),
		            'type'  => 'title',
		            'desc'  => '',
	            ...
	            'refunds_automatic_refunds' => array(
		            'title'   => __( 'Accept all refund requests automatically', 'yith-advanced-refund-system-for-woocommerce' ),
		            'type'    => 'checkbox',
		            'desc'    => __( 'By activating this option, incoming refund requests will be accepted automatically.',
                        'yith-advanced-refund-system-for-woocommerce' ),
	            ...
	            'refunds_restock_items' => array(
		            'title'   => __( 'Restock refunded items on automatic refunds?', 'yith-advanced-refund-system-for-woocommerce' ),
		            'type'    => 'checkbox',
		            'desc'    => __( 'By activating this option, automatic refunds will restock the refunded items (bulk refunds included).',
                        'yith-advanced-refund-system-for-woocommerce' ),
	            ...
	            'refunds_minimum_order_amount' => array(
		            'title'             => __( 'Minimum order amount', 'yith-advanced-refund-system-for-woocommerce' ),
		            'type'              => 'number',
		            'desc'              => __( 'Minimum amount of the order required to accept customers\'s requests.', 'yith-advanced-refund-system-for-woocommerce' ),
	            ...
	            'refunds_enable_message' => array(
		            'title'   => __( 'Enable message to show on non-refundable products', 'yith-advanced-refund-system-for-woocommerce' ),
		            'type'    => 'checkbox',
		            'desc'    => __( 'You can display a message which shows users that the product is refundable.',
			            'yith-advanced-refund-system-for-woocommerce' ),
	            ...
	            'refunds_message' => array(
		            'title'   => _x( 'Message', 'Admin option: custom message for non-refundable products', 'yith-advanced-refund-system-for-woocommerce' ),
		            'type'    => 'textarea',
		            'desc'    => __( 'Custom message for alert users when a product is not refundable.', 'yith-advanced-refund-system-for-woocommerce' ),
		            'id'      => 'yith_wcars_message',
		            'css'     => 'width:50%; height: 65px;',
		            'default' => __( 'Sorry, this product is not refundable.', 'yith-advanced-refund-system-for-woocommerce' )
	            ),
	            ...
	            'file_uploads_title' => array(
		            'title' => __( 'File uploads', 'yith-advanced-refund-system-for-woocommerce' ),
		            'type'  => 'title',
		            'desc'  => '',
	            ...
	            'file_uploads_max_file_size' => array(
		            'title'             => __( 'Maximum file size allowed', 'yith-advanced-refund-system-for-woocommerce' ),
		            'type'              => 'number',
		            'desc'              => __( 'In Kilobytes. 0 means no limit.', 'yith-advanced-refund-system-for-woocommerce' ),
	            ...
	            'file_uploads_enable' => array(
		            'title'   => __( 'Only images', 'yith-advanced-refund-system-for-woocommerce' ),
		            'type'    => 'checkbox',
		            'desc'    => __( 'Allow uploading images only', 'yith-advanced-refund-system-for-woocommerce' ),
	            ...
	            'coupon_settings_title' => array(
		            'title' => __( 'Coupon settings', 'yith-advanced-refund-system-for-woocommerce' ),
		            'type'  => 'title',
		            'desc'  => '',
	            ...
	            'coupon_settings_code' => array(
		            'title'   => __( 'Code', 'yith-advanced-refund-system-for-woocommerce' ),
		            'type'    => 'text',
		            'desc'    => sprintf( __( 'Pattern for automatically generated coupon codes when a coupon is offered in place of a refund. You
	            ...
	            'coupon_settings_expiry_date' => array(
		            'title'   => __( 'Expiry date', 'yith-advanced-refund-system-for-woocommerce' ),
		            'type'    => 'number',
		            'desc'    => __( 'Number of days through which the coupon will be valid. 0 means the coupon will never expire.',
                        'yith-advanced-refund-system-for-woocommerce' ),
