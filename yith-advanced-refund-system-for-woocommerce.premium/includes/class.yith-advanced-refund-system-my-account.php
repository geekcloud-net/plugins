	...
	class YITH_Advanced_Refund_System_My_Account {
		...
		public function add_my_refund_requests_link( $items ) {
			...
			if ( $request_ids ) {
				...
				$items['customer-logout'] = __( 'Logout', 'yith-advanced-refund-system-for-woocommerce' );
			}
			return $items;
		}
                ...
                <table class="ywcars_refund_info">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <div class="ywcars_reduced_text_size ywcars_bold"><?php echo ' ' . get_post( $request->ID )->post_date ?></div>
