...
<div class="ywcars_items_info">
    ...
    <h2 style="display: inline-block; vertical-align: super;"><?php printf( __( 'Request %s for order %s' ), '#' . $request->ID, $order_link );
		?></h2>
    <div class="ywcars_before_items_table">
		...
		if ( $request->whole_order ) {
			...
			$span_product = '<span style="text-decoration: underline;">' . $product->get_title() . '</span>';
    ...
    <div style="overflow: auto;">
        <table class="ywcars_items_table">
            ...
            <tr>
                ...
                <th class="ywcars_items_table_totals ywcars_items_table_refund"><?php _e( 'Refund', 'yith-advanced-refund-system-for-woocommerce' ); ?></th>
			...
			foreach ( $items as $item_id => $item ) {
				...
				if ( 'line_item' == $item_type ) :
                    ...
                    <tr>
                        ...
                        <td><?php echo wc_price( $item_value ); ?></td>
						<?php if ( $tax_enabled ) : ?>
                            <td><?php echo wc_price( $tax_value ); ?></td>
						<?php endif; ?>
                        <td><?php echo $item['qty']; ?></td>
						<?php if ( $tax_enabled ) : ?>
                            <td class="ywcars_items_table_totals"><?php echo wc_price( $item['line_total'] ); ?></td>
                            <td class="ywcars_items_table_totals"><?php echo wc_price( $item['line_tax'] ); ?></td>
						<?php endif; ?>
                        ...
                        <td class="ywcars_items_table_totals ywcars_items_table_refund ywcars_refund_subtotal_data"><?php echo wc_price( $total_refund ); ?></td>
                    </tr>
				<?php else : ?>
                    <tr class="ywcars_non_line_item">
						...
						<?php if ( 'shipping' == $item_type ) : ?>
							...
							<?php if ( $tax_enabled ) : ?>
                                <td></td>
                                <td class="ywcars_items_table_totals"><?php echo wc_price( $shipping_total ); ?></td>
                                <td class="ywcars_items_table_totals"><?php echo wc_price( $shipping_tax ); ?></td>
							<?php endif; ?>
                            <td class="ywcars_items_table_totals"><?php echo wc_price( $shipping_sum ); ?></td>
						...
						<?php if ( 'fee' == $item_type ) : ?>
							...
							<?php if ( $tax_enabled ) : ?>
                                <td></td>
                                <td class="ywcars_items_table_totals"><?php echo wc_price( $fee_total ); ?></td>
                                <td class="ywcars_items_table_totals"><?php echo wc_price( $fee_tax ); ?></td>
							<?php endif; ?>
                            <td class="ywcars_items_table_totals"><?php echo wc_price( $fee_sum ); ?></td>
                            <td class="ywcars_items_table_totals ywcars_items_table_refund ywcars_non_line_item_data">
								<?php if ( ! YITH_Advanced_Refund_System_Request_Manager::order_has_wc_refunds( $order ) && ! $request->is_closed ) : ?>
                                    <input class="ywcars_non_line_item_cb" type="checkbox">
								<?php else : ?>
            ...
            <tr>
				...
				<?php if ( $tax_enabled ) : ?>
                    <td class="ywcars_items_table_totals"><?php echo wc_price( $order->get_total() -  $order_tax ); ?></td>
                    <td class="ywcars_items_table_totals"><?php echo wc_price( $order_tax ); ?></td>
				<?php endif; ?>
        ...
        <div class="ywcars_after_items_table">
            ...
            <div>
                ...
                <button id="ywcars_api_refund_button"
					...
					printf( __( 'Refund %s via %s', 'Refund $amount', 'yith-advanced-refund-system-for-woocommerce' ), $refund_amount, $gateway_name );
					?></button>
