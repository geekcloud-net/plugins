...
class YITH_COG_Report_Totals extends WP_List_Table {
    ...
    public function get_columns() {
        ...
        $columns = array(
            '_void'                 => '',
            'report_total_sales'    => __( 'Total Sales' , 'yith-cost-of-goods-for-woocommerce' ),
            '_void2'                => '',
            'report_total_price'    => __( 'Total Price' , 'yith-cost-of-goods-for-woocommerce' ),
            '_void3'                => '',
            'report_total_cost'     => __( 'Total Cost'  , 'yith-cost-of-goods-for-woocommerce' ),
            '_void4'                => '',
            'report_total_profit'   => __( 'Total Profit', 'yith-cost-of-goods-for-woocommerce' ),
        );
