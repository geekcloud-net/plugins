jQuery(document).ready(function($) {
    ...
    //Placeholder for Custom Fields settings
    $( '#yith_cog_add_columns').attr( 'placeholder', 'Write a Custom Field name ...');
    ...
    function yith_apply_cost_process( limit,offset ) {
        ...
        // if (offset == 0)
        //     if (confirm("This will apply costs to previous orders, are you sure you want to apply costs?.It can take several minutes, depending of the number of orders you have.")) {
            var post_data = {
                'limit': limit,
                'offset': offset,
    ...
    function yith_apply_cost_overriding_process( limit,offset ) {
        ...
        // if (offset == 0)
        //     if (confirm("This will apply costs to previous orders, overriding it, are you sure you want to apply costs?. It can take several minutes, depending of the number of orders you have.")) {
            var post_data = {
                'limit': limit,
                'offset': offset,
