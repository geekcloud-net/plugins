...
if( !empty( $delivery_date ) ):?>
  ...
  <div class="ywcdd-delivery-info-content">
      ...
      <div class="ywcdd-delivery-shipping-info">
          <span class="ywcdd-shipping-label" style="margin-right: 5px;"><strong><?php _e( 'Shipping Date', 'yith-woocommerce-delivery-date' )?>:</strong></span>
          <span class="ywcdd-shipping-value"><?php echo sprintf( '%s %s', __( 'within', 'yith-woocommerce-delivery-date' ), ywcdd_get_date_by_format( $shipping_date ) )?></span>
      </div>
