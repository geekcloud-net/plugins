...
<div class="ywcdd_select_delivery_date_content">
    ...
    <?php if( $processing_method != ''):
        ...
        wc_get_template('woocommerce/checkout/delivery-date-select-date.php', array( 'processing_method'=>$processing_method,'available_days' => $available_days, 'is_mandatory' => $is_mandatory ), YITH_DELIVERY_DATE_TEMPLATE_PATH, YITH_DELIVERY_DATE_TEMPLATE_PATH );
    ?>
    <?php endif;?>
</div>
