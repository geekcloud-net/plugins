	...
	class YITH_WC_Points_Rewards_Redemption {
		...
		public function __construct() {
			...
			if ( version_compare( WC()->version, '2.7', '<' ) ) {
				...
				add_action( 'woocommerce_checkout_update_order_meta', array( $this, 'clear_ywpar_coupon_after_create_order' ), 20 );
			}
		 ...
		 * @return void
		 */
		public function clear_ywpar_coupon_after_create_order( $order ) {
			if ( is_numeric( $order ) ) {
