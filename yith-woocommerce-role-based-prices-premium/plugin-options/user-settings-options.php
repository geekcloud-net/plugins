...
$defaults = array();
$roles_options = array( 'regular'=> __('Regular price','yith-woocommerce-role-based-prices'),
    'on_sale' => __('On sale price','yith-woocommerce-role-based-prices' ), 'your_price' => __('Role-based price',
        'yith-woocommerce-role-based-prices' ), 'add_to_cart'=> __('Add to Cart','yith-woocommerce-role-based-prices'), 'how_show_price' => __('Show Price Incl Tax','yith-woocommerce-role-based-prices')  );
