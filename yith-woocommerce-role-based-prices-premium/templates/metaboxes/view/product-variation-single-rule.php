  ...
  <p class="form-row form-row-full form-row-header">
    ...
    <div class="woocommerce_variation_price_rule_data">
        <p class="form-row form-row-full">
            ...
            <input type="text" name="_product_variable_rule[<?php echo $loop;?>][][rule_name]" class="variation_rule_name" value="<?php esc_attr_e( $rule_name );?>" placeholder="<?php _e('Name your rule','yith-woocommerce-role-based-prices' );?>">
        </p>
        <p class="form-row form-row-full">
            <label><?php _e('Apply to','yith-woocommerce-role-based-prices');?></label>
            <select name="_product_variable_rule[<?php echo $loop;?>][][rule_role]"  class="multiselect variation_role wc-enhanced-select" placeholder="<?php _e('Select user role','yith-woocommerce-role-based-prices');?>">
                <?php
        ...
        <p class="form-row form-row-first">
            ...
            <input type="hidden" name="_product_variable_rule[<?php echo $loop;?>][][rule_type]" value="<?php esc_attr_e( $rule_type );?>">
        </p>
        <p class="form-row form-row-last">
            <label><?php echo $label_role_value;?></label>
            <input type="text" class="short variation_val <?php echo $class_price;?>" value="<?php esc_attr_e( $role_value );?>" name="_product_variable_rule[<?php echo $loop;?>][][rule_value]">
        </p>
    </div>
