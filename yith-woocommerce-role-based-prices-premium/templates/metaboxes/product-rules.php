...
?>
<div class="options_group product_price_rule show_if_simple show_if_external">
    <div class="toolbar toolbar-top">
		<span class="expand-close">
		    <a href="#" class="expand_all_price_rule"><?php _e( 'Expand', 'woocommerce');?></a> / <a href="#" class="close_all_price_rule"><?php _e( 'Close', 'woocommerce' );?></a>
        </span>
   ...
   <div class="options_group how_apply_product_rule">
    <p class="form-field">
      <span class="only_this">
          ...
          <input type="radio" value="only_this" name="how_apply_product_rule" <?php checked( 'only_this',$how_apply );?> >
      </span>
       <span class="only_user">
           <label><?php _e('Override rules created for the same user role','yith-woocommerce-role-based-prices');?></label>
            <input type="radio" value="only_user" name="how_apply_product_rule" <?php checked( 'only_user',$how_apply );?>>
       </span>
    </p>
   </div>
