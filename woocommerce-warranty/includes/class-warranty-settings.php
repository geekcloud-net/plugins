        ...
        return apply_filters( 'woocommerce_warranty_settings', array(
            'general'   => array(
                ...
                array(
                    ...
                    'default'   => 'no',
                    'type'      => 'select',
                    'options'   => array('no' => __('No', 'wc_warranty'), 'yes' => __('Yes', 'wc_warranty')),
                    'desc_tip'  => true
                ),
                ...
                array(
                    'name'      => __( 'Only allow refunds/credits on this status', 'wc_warranty' ),
                    'desc'      => __( 'What Warranty statuses do you want to enable the refunds/credits?', 'wc_warranty' ),
                    'tip'       => '',
