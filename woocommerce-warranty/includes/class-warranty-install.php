...
class Warranty_Install {
	...
	public function create_options() {
		if ( false == get_option( 'warranty_request_statuses', false ) ) {
			$options = array(
				'warranty_request_statuses'             => array( 'processing', 'completed' ),
				...
				'warranty_button_text'                  => 'Request Warranty',
				'view_warranty_button_text'             => 'View Warranty Status',
				'warranty_reset_statuses'               => 'no',
				'warranty_enable_refund_requests'       => 'no',
				'warranty_enable_coupon_requests'       => 'no',
				'warranty_refunds_statuses'             => array( 'completed' ),
				'warranty_print_logo'                   => '',
