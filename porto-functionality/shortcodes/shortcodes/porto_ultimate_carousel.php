...
function porto_load_ultimate_carousel_shortcode() {
    ...
    vc_map(
        array(
            "name"                    => __( "Porto Advanced Carousel", "porto-shortcodes" ),
            ...
            "description"             => __( "Carousel anything.", "porto-shortcodes" ),
            "params"                  => array(
                array(
                    "type"       => "dropdown",
                    "class"      => "",
                    "heading"    => __( "Slides to Scroll", "porto-shortcodes" ),
                ...
                array(
                    ...
                    "heading"          => __( "On Desktop", "porto-shortcodes" ),
                ...
                array(
                    ...
                    "class"            => "",
                    "edit_field_class" => "vc_col-sm-4 items_to_show porto_margin_bottom",
                    "heading"          => __( "On Tabs", "porto-shortcodes" ),
                ...
                array(
                    ...
                    "class"            => "",
                    "edit_field_class" => "vc_col-sm-4 items_to_show porto_margin_bottom",
                    "heading"          => __( "On Mobile", "porto-shortcodes" ),
                ...
                array(
                    "type"        => "dropdown",
                    "class"       => "",
                    "heading"     => __( "Autoplay Slides‏", "porto-shortcodes" ),
                    "param_name"  => "autoplay",
                    "value"     => array(
                        "Yes" => "on",
                        "No" => "off",
                ...
                array(
                    "type"       => "number",
                    "class"      => "",
                    "heading"    => __( "Autoplay Speed", "porto-shortcodes" ),
                ...
                array(
                    "type"        => "dropdown",
                    "class"       => "",
                    "heading"     => __( "Navigation Arrows", "porto-shortcodes" ),
                    "description" => __( "Display next / previous navigation arrows", "porto-shortcodes" ),
                    "param_name"  => "arrows",
                    "value"       => array(
                        "Yes" => "on",
                        "No" => "off",
                ...
                array(
                    "type"       => "dropdown",
                    "class"      => "",
                    "heading"    => __( "Arrow Style", "porto-shortcodes" ),
                ...
                array(
                    "type"       => "colorpicker",
                    "class"      => "",
                    "heading"    => __( "Arrow Color", "porto-shortcodes" ),
                ...
                array(
                    "type"       => "number",
                    "class"      => "",
                    "heading"    => __( "Arrow Size", "porto-shortcodes" ),
                ...
                array(
                    'type' => 'dropdown',
                    'heading' => __( 'Icon library', 'porto-shortcodes' ),
                    'value' => array(
                ...
                array(
                    "type"       => "iconpicker",
                    "class"      => "",
                    "heading"    => __( "Select icon for 'Next Arrow'", "porto-shortcodes" ),
                ...
                array(
                    "type"       => "iconpicker",
                    "class"      => "",
                    "heading"    => __( "Select icon for 'Previous Arrow'", "porto-shortcodes" ),
                ...
                array(
                    "type"        => "dropdown",
                    "class"       => "",
                    "heading"     => __( "Dots Navigation", "porto-shortcodes" ),
                    "description" => __( "Display dot navigation", "porto-shortcodes" ),
                    "param_name"  => "dots",
                    "value"       => array(
                        "Yes" => "on",
                        "No" => "off",
                ...
                array(
                    "type"       => "colorpicker",
                    "class"      => "",
                    "heading"    => __( "Color of dots", "porto-shortcodes" ),
                ...
                array(
                    'type' => 'dropdown',
                    'heading' => __( 'Icon library for \'Navigation Dots\'', 'porto-shortcodes' ),
                    'value' => array(
                        __( 'Font Awesome', 'porto-shortcodes' ) => 'fontawesome',
                        __( 'Simple Line Icon', 'porto-shortcodes' ) => 'simpleline',
                        __( 'Porto Icon', 'porto-shortcodes' ) => 'porto',
                ...
                array(
                    "type"       => "iconpicker",
                    "class"      => "",
                    "heading"    => __( "Select icon for 'Navigation Dots'", "porto-shortcodes" ),
                    "param_name" => "dots_icon",
                    "value"      => "fa fa-circle-o",
                    'dependency' => array('element' => 'dots_icon_type', 'value' => 'fontawesome'),
                    "group"      => "Navigation",
                ),
                array(
                    "type"       => "iconpicker",
                    ...
                    'dependency' => array('element' => 'dots_icon_type', 'value' => 'simpleline'),
                    "group"      => "Navigation",
                ),
                array(
                    "type"       => "iconpicker",
                    ...
                    'dependency' => array('element' => 'dots_icon_type', 'value' => 'porto'),
                    "group"      => "Navigation",
                ),
                $animation_type,
                array(
                    "type"       => "dropdown",
                    "class"      => "",
                    "heading"    => __( "RTL Mode", "porto-shortcodes" ),
                    "param_name" => "rtl",
                    "value"    => array(
                        "No" => "",
                        "Yes" => "on",
                ...
                array(
                    "type"       => "dropdown",
                    "class"      => "",
                    "heading"    => __( "Adaptive Height", "porto-shortcodes" ),
                ...
                array(
                    "type"       => "number",
                    "class"      => "",
                    "heading"    => __( "Space between two items", "porto-shortcodes" ),
