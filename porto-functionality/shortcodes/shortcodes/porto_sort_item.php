...
function porto_load_sort_item_shortcode() {
    ...
    vc_map( array(
        "name" => "Porto " . __("Sort Item", 'porto-shortcodes'),
        ...
        "params" => array(
            ...
            array(
                "type" => "textfield",
                "heading" => __("Popular Order Value", "porto-shortcodes"),
                "param_name" => "popular",
                "value" => "0",
                "admin_label" => true
            ),
            ...
            array(
                "type" => "dropdown",
                "heading" => __("Width on Large Screen", "porto-shortcodes"),
                "param_name" => "width_lg",
                "value" => porto_sh_commons('grid_columns')
            ),
            array(
                "type" => "dropdown",
                "heading" => __("Width on Medium Screen", "porto-shortcodes"),
                "param_name" => "width_md",
                "value" => porto_sh_commons('grid_columns')
            ),
            array(
                "type" => "dropdown",
                "heading" => __("Width on Small Screen", "porto-shortcodes"),
                "param_name" => "width_sm",
                "value" => porto_sh_commons('grid_columns')
            ),
            array(
                "type" => "dropdown",
                "heading" => __("Width on Extra Small Screen", "porto-shortcodes"),
                "param_name" => "width_xs",
                "value" => porto_sh_commons('grid_columns')
            ),
            $custom_class
