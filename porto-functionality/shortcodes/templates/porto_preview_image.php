...
if ($image_url) {
    $output = '<div class="porto-preview-image ' . $el_class . '">';
    ...
    $output .= '<span class="thumb-info thumb-info-preview' .
        ...
        '">'. ($tip_label ? '<span class="thumb-info-ribbon' . (($tip_skin != 'custom') ? ' thumb-info-ribbon-' . $tip_skin : '') . '"><span>' . $tip_label . '</span></span>' : '') .'<span class="thumb-info-wrapper">
