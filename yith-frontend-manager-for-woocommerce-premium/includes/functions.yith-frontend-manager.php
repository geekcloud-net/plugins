...
if ( ! function_exists( 'yith_wcfm_install_woocommerce_admin_notice' ) ) {
	...
	function yith_wcfm_install_woocommerce_admin_notice() {
		?>
        <div class="error">
            <p><?php _e( 'YITH Frontend Manager for WooCommerce is enabled but not effective. It requires WooCommerce in order to work.', 'yith-frontend-manager-for-woocommerce' ); ?></p>
        </div>
		<?php
	}
}
...
if ( ! function_exists( 'yith_wcfm_echo_product_categories_childs_of' ) ) {
	/**
	 * Show WooCommerce Childs Categories
	 *
	 * @author Andrea Grillo <andrea.grillo@yithemes.com>
	 * @since 1.3.3
	 * @return void
