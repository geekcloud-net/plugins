    ...
    class YITH_Frontend_Manager_For_Name_Your_Price{
        ...
        public function __construct()
        {
            if( defined( 'YWCNP_PREMIUM' )) {
                ...
                add_action( 'wp_enqueue_scripts', array( $name_your_price_admin, 'include_premium_scripts' ) );
                add_action( 'wp_enqueue_scripts', array( $name_your_price_admin, 'include_premium_styles' ) );
