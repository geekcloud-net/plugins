	...
	class YITH_Frontend_Manager_Section_Live_Chat extends YITH_WCFM_Section {
		...
		public function enqueue_section_scripts() {
			...
			switch ( true ) {
				...
				case $this->is_current( $this->_subsections['chat-logs']['slug'] ):
				case $this->is_current( $this->_subsections['offline-messages']['slug'] ):
				...
				case $this->is_current( $this->_subsections['ylc-macro']['slug'] ):
				case $this->is_current( $this->_subsections['ylc-macros']['slug'] ):
					break;
				default:
