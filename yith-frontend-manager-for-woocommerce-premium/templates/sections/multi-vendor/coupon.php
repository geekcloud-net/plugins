    ...
    <form name="post" action="<?php echo add_query_arg( array( 'code' => $coupon_code ), $endpoint_url ); ?>" method="post" id="post">
        ...
        <div class="options_group">
            ...
            <p class="form-field exclude_sale_items_field ">
                ...
                <span class="description"><?php echo __('Check this box if the coupon should not apply to items on sale. Per-item coupons will only work if the item is not on sale. Per-cart coupons will only work if there are no sale items in the cart.', 'yith-frontend-manager-for-woocommerce'); ?></span>
            </p>
