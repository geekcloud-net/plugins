...
* Plugin URI: http://yithemes.com/themes/plugins/yith-frontend-manager-for-woocommerce/
* Description: YITH Frontend Managerfor WooCommerce is a plugin .....
* Author: YITHEMES
...
//! defined( 'YITH_WCFM_FREE' )                && define( 'YITH_WCFM_FREE', '1' );
//! defined( 'YITH_WCFM_FREE_INIT' )           && define( 'YITH_WCFM_FREE_INIT', plugin_basename( __FILE__ ) );
! defined( 'YITH_WCFM_INIT' )                && define( 'YITH_WCFM_INIT', plugin_basename( __FILE__ ) );
! defined( 'YITH_WCFM_VERSION' )             && define( 'YITH_WCFM_VERSION', '1.4.3' );
...
//@TODO: To remove in free version
