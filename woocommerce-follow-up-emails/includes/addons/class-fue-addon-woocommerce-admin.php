...
class FUE_Addon_Woocommerce_Admin {
	...
	public function product_variables( $email ) {
		...
		<li class=""><strong>{item_url}</strong> <img class="help_tip" title="<?php _e('The URL of the purchased item. Only works when the product is specified in the trigger setting.', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
