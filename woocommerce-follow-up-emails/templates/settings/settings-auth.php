...
<form action="admin-post.php" method="post" enctype="multipart/form-data">
	...
	<table class="form-table">
		...
		<tr class="dkim">
		  <?php if ( !function_exists( 'openssl_pkey_new' ) ): ?>
			  <th>&nbsp;</th>
			  <td>
				<?php _e('To generate new keys, please enable the OpenSSL extension in your PHP installation.', 'follow_up_emails'); ?>
			  </td>
		  <?php else: ?>
	...
	<table class="form-table dkim">
	  <tr>
		  <th>&nbsp;</th>
		  <td>
			  <input type="button" class="button-secondary generate-dkim-keys" value="<?php _e('Generate DKIM Keys', 'follow_up_emails'); ?>" />
