jQuery(function ($) {
    ...
    $(document).ready(function ($) {
         ...
         * Plugin admin panel
         */
        $('#ywmmq_cart_quantity_limit, #ywmmq_category_value_limit, #ywmmq_tag_value_limit, #ywmmq_rules_enable').change(function () {
        ...
        $('#ywmmq_product_quantity_limit, #ywmmq_category_quantity_limit, #ywmmq_tag_quantity_limit').change(function () {

            var rows = $(this).parent().parent().parent().parent().nextAll('*:lt(3)');
        ...
        $('#ywmmq_message_enable_atc').change(function () {
            ...
            var rows = $(this).parent().parent().parent().parent().nextAll('*:lt(16)');
