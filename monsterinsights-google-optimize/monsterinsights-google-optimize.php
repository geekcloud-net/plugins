...
class MonsterInsights_Google_Optimize {
	...
	public function requires_monsterinsights_version() {
		?>
		<div class="error">
			<p><?php esc_html_e( 'Please install or update MonsterInsights Pro with version 6.0 or newer to use the MonsterInsights Google Optimize addon', 'monsterinsights-google-optimize' ); ?></p>
		</div>
		<?php
	}
